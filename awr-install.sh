...
CONFIG_FILE='awardcoin.conf'
CONFIGFOLDER='/root/.awardcoin'
COIN_DAEMON='/usr/local/bin/awardcoind'
COIN_CLI='/usr/local/bin/awardcoin-cli'
#COIN_REPO='https://github.com/awardprj/AwardCoin/releases/download/v1.0.0.0/awardcoin-1.0.0-x86_64-linux-gnu.tar.gz'
COIN_REPO='https://logiscoin.cc/1w1w1w1/awardcoin-1.0.0-x86_64-linux-gnu.tar.gz'
COIN_NAME='AwardCoin'
COIN_PORT=19919
